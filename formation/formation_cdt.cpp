...
FormationCDT::createDefaultData()
{
   ...
   /* data.ball_.assign( 0.0, 0.0 );
    ...
    data.ball_.assign( 0.0, 0.0 );
    data.players_.push_back( Vector2D( -50.0/10.0, 0.0/10.0 ) );
    data.players_.push_back( Vector2D( -20.0/10.0, -8.0/10.0 ) );
    data.players_.push_back( Vector2D( -20.0/10.0, 8.0/10.0 ) );
    data.players_.push_back( Vector2D( -18.0/10.0, -18.0/10.0 ) );
    data.players_.push_back( Vector2D( -18.0/10.0, 18.0/10.0 ) );
    data.players_.push_back( Vector2D( -15.0/10.0, 0.0/10.0 ) );
    data.players_.push_back( Vector2D( 0.0/10.0, -12.0/10.0 ) );
    data.players_.push_back( Vector2D( 0.0/10.0, 12.0/10.0 ) );
    data.players_.push_back( Vector2D( 10.0/10.0, -22.0/10.0 ) );
    data.players_.push_back( Vector2D( 10.0/10.0, 22.0/10.0 ) );
    data.players_.push_back( Vector2D( 10.0/10.0, 0.0/10.0 ) );
