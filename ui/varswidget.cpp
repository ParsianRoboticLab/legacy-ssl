...
CVarsWidget::CVarsWidget()
{
    ...
    ADD_TREE(LocalSettings,"Local Settings",true)
            ...
            ADD_ENUM(LocalSettings,StringEnum,LineUpPosition,"OurCornerL","LineUp Position")
            ADD_TO_ENUM(LocalSettings,LineUpPosition,"OurCornerL")
            ADD_TO_ENUM(LocalSettings,LineUpPosition,"OurCornerR")
    ...
    ADD_TREE(BallTracker,"Ball Tracker & Vision",false)
            ...
            ADD_VALUE(BallTracker,Bool,cam5on,true,"Camera 5")
            ADD_VALUE(BallTracker,Bool,cam6on,true,"Camera 6")
            ADD_VALUE(BallTracker,Bool,cam7on,true,"Camera 7")
            ADD_VALUE(BallTracker,Bool,cam8on,true,"Camera 8")
...
IMPL_VALUE(CVarsWidget,BallTracker,bool,Bool,cam5on)
IMPL_VALUE(CVarsWidget,BallTracker,bool,Bool,cam6on)
IMPL_VALUE(CVarsWidget,BallTracker,bool,Bool,cam7on)
IMPL_VALUE(CVarsWidget,BallTracker,bool,Bool,cam8on)
