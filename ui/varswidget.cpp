...
CVarsWidget::CVarsWidget()
{
    ...
    ADD_TREE(LocalSettings,"Local Settings",true)
            ...
            ADD_VALUE(BangBang,Double,AccTangent_Max,7.0,"Acc Tan")
            ADD_VALUE(BangBang,Double,DecTangent_Max,1.8,"Dec Tan")
            ADD_VALUE(BangBang,Double,AccNormal_Max,4.0,"Acc Norm")
            ADD_VALUE(BangBang,Double,DecNormal_Max,1.0,"Dec Norm")
            ADD_VALUE(BangBang,Double,VelTangent_Max,3.6,"Vel Max")
            ADD_VALUE(BangBang,Double,VelNormal_Max,2.0,"Vel Norm Max")
            ADD_VALUE(BangBang,Double,AccCurve_Max,1.0,"Acc Curve")
            ADD_VALUE(BangBang,Double,DecCurve_Max,0.8,"Dec Curve")
            ADD_VALUE(BangBang,Double,VelCurve_Max,4.5,"Vel Curve")
            ADD_VALUE(BangBang,Int,MotorRPM,1240,"Motors RPM")
            ADD_VALUE(BangBang,Double,KP,0.0,"Controler K P")
            ADD_VALUE(BangBang,Double,KI,0.0,"Controler K I")
            ADD_VALUE(BangBang,Double,KD,0.0,"Controler K D")
            ADD_VALUE(BangBang,Double,OneKP,0.0,"OneTouch K P")
            ADD_VALUE(BangBang,Double,OneKI,0.0,"OneTouch K I")
            ADD_VALUE(BangBang,Double,OneKD,0.0,"OneTouch K D")
            ADD_VALUE(BangBang,Double,Gain,0.0,"Controler Gain")
    ...
    ADD_TREE(SkillsParams,"Skills Parameters",false)
            ...
            ADD_VALUE(Performance_Debug, Bool, debugTemp, false, "Temp")
...
IMPL_VALUE(CVarsWidget,BangBang,double,Double,AccTangent_Max)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,DecTangent_Max)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,AccNormal_Max)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,DecNormal_Max)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,VelTangent_Max)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,VelNormal_Max)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,AccCurve_Max)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,DecCurve_Max)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,VelCurve_Max)
IMPL_VALUE(CVarsWidget,BangBang,int,Int,MotorRPM)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,KP)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,KI)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,KD)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,OneKP)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,OneKI)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,OneKD)
IMPL_VALUE(CVarsWidget,BangBang,double,Double,Gain)
...
IMPL_VALUE(CVarsWidget,Performance_Debug, bool, Bool, debugTemp)
