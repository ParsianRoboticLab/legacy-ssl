...
public:
  ...
  DEF_TREE(BangBang)
      DEF_VALUE(BangBang,double,Double,AccTangent_Max)
      DEF_VALUE(BangBang,double,Double,DecTangent_Max)
      DEF_VALUE(BangBang,double,Double,AccNormal_Max)
      DEF_VALUE(BangBang,double,Double,DecNormal_Max)
      DEF_VALUE(BangBang,double,Double,VelTangent_Max)
      DEF_VALUE(BangBang,double,Double,VelNormal_Max)
      DEF_VALUE(BangBang,double,Double,AccCurve_Max)
      DEF_VALUE(BangBang,double,Double,DecCurve_Max)
      DEF_VALUE(BangBang,double,Double,VelCurve_Max)
      DEF_VALUE(BangBang,int,Int,MotorRPM)
      DEF_VALUE(BangBang,double,Double,KP)
      DEF_VALUE(BangBang,double,Double,KI)
      DEF_VALUE(BangBang,double,Double,KD)
      DEF_VALUE(BangBang,double,Double,OneKP)
      DEF_VALUE(BangBang,double,Double,OneKI)
      DEF_VALUE(BangBang,double,Double,OneKD)
      DEF_VALUE(BangBang,double,Double,Gain)
  DEF_TREE(Kalman)
...
class CPolicyWidget : public QWidget
{
  ...
  public:
   ...
   DEF_TREE(Defense)
    ...
    DEF_TREE(KKPlayOff)
            DEF_VALUE(KKPlayOff, std::string, String, KKPOPlanSQL)
            DEF_VALUE(KKPlayOff, bool, Bool, KKPOSymmetry)
            DEF_VALUE(KKPlayOff, bool, Bool, KKPOUseDef)
