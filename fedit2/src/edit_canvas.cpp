...
#define TopGoal 0.35
#define ButtonGoal -0.35
#define FieldWidth 6.05
...
EditCanvas::drawField( QPainter & painter )
{
    ...
    if ( s_first )
    {
       ...
       //
        //
        // center circle
        s_lines.addEllipse(-0.5, -0.5, 1.0, 1.0);
#else
...
#else
    QRectF leftPenalty, rightPenalty;
     leftPenalty.setRect(-_FIELD_WIDTH/2.0, -0.975, 0.800, 1.950);
    rightPenalty.setRect(_FIELD_WIDTH/2.0-0.8, -0.975, 0.800, 1.950);
#endif
